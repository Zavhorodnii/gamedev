...
//    wp_enqueue_style( 'style', get_template_directory_uri() . '/css/_style.css' );
...
//    wp_enqueue_script('popups', get_template_directory_uri() .'/js/popups.js');
...
function my_duplicate_post_link($actions, $post)
{
    ...
    {
        $actions['answer_email'] = '<a href="' . get_admin_url( null, 'admin.php?page=message-reply&post_id=' . $post->ID, '' ) . '" title="" rel="permalink">Answer</a>';
    }
    return $actions;
}
